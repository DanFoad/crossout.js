...
var Crossout = function(args) {
    ...
    this.reverseDirection = args.reverseDirection || false;
...
Crossout.prototype.addLine = function(el, attributes) {
    ...
    var reverseDirection = (attributes.reverseDirection == 'true')  || this.reverseDirection;
    var mult = (reverseDirection) ? 0.5 : -0.5;
